<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Communication_Post_Modify.aspx.cs" Inherits="CoviDoctor_ASP.Communication_Post.Communication_Post_Modify" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table align="center" class="auto-style1">
        ...
        1. 게시판 내에서의 비방 및 욕설, 비속어 사용을 금지합니다.
                    <br />
                    <br />&nbsp; 2. 허위 사실, 확인/검증되지 않은 루머 글 또는 음란성 게시물 등을
                    <br />&nbsp;&nbsp;&nbsp;&nbsp; 작성하는 일은 없도록 합시다.
                    <br />
                    <br />&nbsp; 3. 전 항에 해당하는 게시물은 개별 알림 및 사전 고지 없이 삭제됩니다.</div>
            </td>
        </tr>
    </table>
