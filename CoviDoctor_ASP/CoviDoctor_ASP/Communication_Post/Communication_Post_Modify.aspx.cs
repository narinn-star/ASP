...
namespace CoviDoctor_ASP.Communication_Post
{
    public partial class Communication_Post_Modify : System.Web.UI.Page
    {
        string name = "";
        string id = "";
        string date = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Cmd.Connection = Con;
            Cmd.CommandText = "select * from c_board where idx = '" + Session["updatefocus"] + "'";
